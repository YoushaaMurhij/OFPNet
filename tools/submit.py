...
def parse_args():
    ...
    parser.add_argument("--pretrained" , default="pretrained/20220430_221205_R2AttU_T2_sepHead/Epoch_2_Iter_10146.pth", help="Use pre-trained models")
...
def main(args):
    ...
    for i, test_shard_path in enumerate(tqdm(test_shard_paths)):
        ...
        generate_predictions_for_one_test_shard(
            ...
            model=model)
        save_submission_to_file(submission=submission, test_shard_path=test_shard_path, folder=args.method)
